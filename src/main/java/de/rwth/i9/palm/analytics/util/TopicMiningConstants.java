...
public class TopicMiningConstants
{
	...
	// "/home/ec2-user/thesis/mallet-files/";
	// public static final String USER_YEARS_FOLDER_PATH = USER_DESKTOP_PATH +
	// "Years/";
	// public static final String USER_MALLET_PATH =
	// "/home/ec2-user/thesis/mallet/";
	//
	// public static final String USER_PROCESS_COMMAND_INPUT = USER_MALLET_PATH
	// + "\"&& bin/mallet import-dir --input " + USER_DESKTOP_PATH;
